...
const image = {
  url: {
    ...
    D_E_TMB:
      "https://i.imgur.com/DyLAuEh.jpg",
    D_E_DP_:
      "https://imgur.com/AelfUJg.jpg",
    D_E_ERR:
      "https://imgur.com/ggvhL6C.jpg",
  },
  encd: {
    D_E_TMB:
...
const exif = {
  footer: "ɪɴʀʟ-ᴍᴅ",
  packname: "ɪɴʀʟ-ʙᴏᴛ",
  name: myconfig.profile.botName || "ɪɴʀʟ",
  author: myconfig.profile.ownerName || "ɪɴʀʟ",
  owner: myconfig.profile.ownerNumb ? ["917591939575"].push(myconfig.profile.ownerNumb) : ["917591939575"],
  cap: "*Cerated by inrlTeam*",
  web: "https://frendpage.vercel.app/",
  github: "https://github.com/inrl-official/inrl-bot-md",
  sc: "https://github.com/inrl-official/inrl-bot-md.git",
  YT: "https://www.youtube.com/channel/null",
};
const quoted = {
  image: {
